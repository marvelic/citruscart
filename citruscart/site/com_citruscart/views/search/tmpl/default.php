...
<form action="<?php echo JRoute::_( $form['action'] )?>" method="post" class="form-horizontal adminform" name="adminForm" id="adminForm" enctype="multipart/form-data">
    ...
    <div id="citruscart_searchfilters">
        ...
        <div class="row filtername" >
            <label class="control-label"><?php echo JText::_('COM_CITRUSCART_NAME'); ?>:</label>
        ...
        <div class="row filtermulticategory" >
            <label class="control-label"><?php echo JText::_('COM_CITRUSCART_CATEGORY'); ?>: </label>
        ...
        <div class="row filtershipping" >
            <label  class="control-label"><?php echo JText::_('COM_CITRUSCART_REQUIRES_SHIPPING'); ?>: </label>
        ...
        <div class="row filtersku" >
            <label class="control-label"><?php echo JText::_('COM_CITRUSCART_SKU'); ?>: </label>
            <input id="filter_sku" name="filter_sku" value="<?php echo $state->filter_sku; ?>" size="15" class="text_area" />
        </div>

        <div class="row price">
        	<label class="control-label"><?php echo JText::_('COM_CITRUSCART_PRICE_RANGE'); ?>: </label>
            <div class="range">
            	<!-- <div> -->
            	<label class="">
            		<?php echo JText::_('COM_CITRUSCART_FROM'); ?>:
            		<div>
            			<input id="filter_price_from" name="filter_price_from" value="<?php echo $state->filter_price_from; ?>" size="5" class="input" class="text_area" />
        	</div>
            	</label>
                <label  class="">
                	<?php echo JText::_('COM_CITRUSCART_TO'); ?>:
                		<div>
                			<input id="filter_price_to" name="filter_price_to" value="<?php echo $state->filter_price_to; ?>" size="5" class="input" class="text_area" />
        </div>
               </label>
        ...
        <div class="reset"></div>
	        <div class="control-group">
            	...
            	<?php echo JText::_('COM_CITRUSCART_SHOW_ONLY_ITEMS_THAT_ARE_IN_STOCK'); ?>: </label>
            <?php echo CitruscartSelect::booleanlist( 'filter_stock', '', $state->filter_stock ); ?>
        </div>

        <div class="row filterdescription" >
            <label class="control-label"><?php echo JText::_('COM_CITRUSCART_DESCRIPTION'); ?>: </label>
        ...
        <div class="row filtermanufacturer" >
            <label class="control-label"><?php echo JText::_('COM_CITRUSCART_MANUFACTURER'); ?>: </label>
